...
st1:    cli 					; clear interrupt flag, because we won't be using maskable innterrupts
	...
	counter_0 equ 08h			; Variable declarations for 8255-3
	creg equ 0Eh
	
	mov al,10000000b 			;programming 8255-2 to work in mode 0
	out creg2,al
	
	mov al,10011011b 			;programming 8255-2 to work in mode 0
	out creg1,al
	...
	;initialisation of lcd
		...
		;Didnt understand anything below this
	...
	;initialisation end
		...
		mov hour_12,0
		mov format_check,0
		mov phase,0				; Initiazed time to 7:00 pm
		...
		mov alarm_hour_12,0
		mov alarm_min,0 
		mov alarm_phase,0		; setting alarm for 7:01 pm
